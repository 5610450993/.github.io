...
function submited(){
	...
	if(pnumber == "" || pnumber.length < 12){
		document.getElementById("err_pn").innerHTML = "please enter digit 6";
		err = true;
	}else{
		document.getElementById("err_pn").innerHTML = "";	
	}
	
	if(cpnumber == "" || cpnumber.length < 14){
		document.getElementById("err_cpn").innerHTML = "please enter digit 9";
		err = true;
	}else{
		document.getElementById("err_cpn").innerHTML = "";	
	}
	
	if(bday == "" || bday.length < 10){
		document.getElementById("err_bd").innerHTML = "please enter the correct";
		err = true;
	}else{
		document.getElementById("err_bd").innerHTML = "";	
	}
	
	if(cnum == "" || cnum.length < 13){
		document.getElementById("err_cn").innerHTML = "please enter digit 13";
		err = true;
	}else{
	...
	if(adress == ""){
		document.getElementById("err_a").innerHTML = "please enter your adress";
		err = true;
	}else{
	...
	if (confirm("welcome again: " + getCookie("firstname")) == true) {
        document.getElementById("result_fn").innerHTML = fname;
		document.getElementById("result_ln").innerHTML = lname;
		document.getElementById("result_pn").innerHTML = pnumber;
		document.getElementById("result_cpn").innerHTML = cpnumber;
		document.getElementById("result_bd").innerHTML = bday;
		document.getElementById("result_cn").innerHTML = cnum;
		document.getElementById("result_zs").innerHTML = zsign;
		document.getElementById("result_zy").innerHTML = zyear;
		document.getElementById("result_bdow").innerHTML = zyear;
		document.getElementById("result_a").innerHTML = adress;
		switchingPage();
    }
